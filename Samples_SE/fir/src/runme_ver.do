...
set reference_asdb wave_verilog.asdb

cd $dsn/src
#Run reference design
adel -all
alog -sv2k5 ff.v rom_c1c5.v rom_c2c4.v rom_c3.v adder_2x8_wrapper.v adder_7x8.v fir.v tb.v
...
write awc wave_verilog.awc
close -wave

#Create wavebench files for expression
do -tcl wavebench.tcl Verilog $reference_signal_file $expression_signals_file $cursors_file $wavebenchname $reference_asdb

#Run simulation with expression
do  ${wavebenchname}_Verilog/${wavebenchname}.do
